...
<head>
  ...
  <title>Library | <?php echo $colle_Name; ?></title>
...
<section class="hero-section" style="background: url('../assets/img/library/library_front.jpg') no-repeat center/cover;">
  <h1 class="dept-heading">Library</h1>
</section>
