...
<div class="container main_container">
  ...
  <!-- Members -->
  <div class="mt-5">
    <h3 class="text-center">NSS Team</h3>
    <div class="table-responsive">
      <table class="table table-striped table-hover mt-3">
        ...
        <tbody>
          <tr>
            <td>Coordinator</td>
            <td>Mr. R. Pradeep Kumar, AP/ECE</td>
          </tr>
          <tr>
            <td>Coordinator</td>
            <td>Mr. B. Nagarajan, AP/MECH</td>
          </tr>
          <tr>
            <td>Coordinator</td>
          ...
          <tr>
            <td>Members</td>
            <td>Mr. P. Arul Jebaraj, AP/Civil</td>
          </tr>
          <tr>
            <td>Members</td>
            <td>Mr. N. Kesavamoorthy, AP/CSE</td>
          </tr>
          <tr>
            <td>Members</td>
            <td>Mrs. N. Abirami, AP/EEE</td>
          </tr>
          <tr>
            <td>Members</td>
          ...
          <tr>
            <td>Members</td>
            <td>Mr. J. Vinothkumar, AP/AI&DS</td>
          </tr>
          <tr>
            <td>Members</td>
            <td>Mrs. M. Arulvizhi, AP/Maths</td>
          </tr>
        </tbody>
      </table>
    </div>
