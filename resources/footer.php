<div class="footer_main" >
    <footer class="main_footer">
        <div class="footer_sec_1 footer_section">
            <p>
        ...
        <div class="footer_sec_2 footer_section ml-5">
            <h2>
                USEFUL LINK
            </h2>
        ...
        <div class="footer_sec_3 footer_section">
            <h2>
                DISCLOSURE
            </h2>
            <ul>
        ...
        <div class="footer_sec_4 footer_section">
            <h2>
                Contact
            </h2>
