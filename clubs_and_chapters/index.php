...
<head>
  ...
  <title>Clubs & Chapters | <?php echo $colle_Name; ?></title>
  ...
  <link rel="stylesheet" href="../assets/css/clubs_and_chapters/style.css">
...
<section class="hero-section" style="background: url('../assets/img/clubs_and_chapters/main.png') no-repeat center/cover;">
  <h1 class="dept-heading">Clubs & Chapters</h1>
</section>
